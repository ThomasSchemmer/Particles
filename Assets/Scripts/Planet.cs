...
public class Planet : MonoBehaviour
{
    ...
    private ComputeBuffer particleBuffer, debugBuffer;
    ...
    private int maxParticles = 128000;
    ...
    void Update()
    {
        ...
        Particle[] arr = new Particle[maxParticles / 2];
        particleBuffer.GetData(arr);
        float[] debug = new float[particles.Count];
    ...
    private void CreateBuffers() {
        ...
        shader.SetBuffer(drawKernel, "debug", debugBuffer);
